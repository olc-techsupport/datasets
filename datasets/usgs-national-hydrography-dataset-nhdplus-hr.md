...
| Topics / proposed series | Hydrology; series assignment unconfirmed |
...
[Original discovery link](https://www.usgs.gov/core-science-systems/ngp/national-hydrography). This entry is a discovery lead, not a verified endpoint. Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

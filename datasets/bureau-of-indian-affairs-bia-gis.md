# Bureau of Indian Affairs (BIA) GIS
...
User reports implementation. Reviewed boundary code uses Census TIGER; keep the BIA layer and its repository link separate until identified.
...
[Original discovery link](https://www.bia.gov/gis). Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

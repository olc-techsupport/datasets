...
| --- | --- |
| Status | candidate |
| Entry type | portal / resource |
| Topics / proposed series | Agricultural Data; series assignment unconfirmed |
...
[Original discovery link](https://www.nass.usda.gov/Data_and_Statistics/index.php). This entry is a discovery lead, not a verified endpoint. Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

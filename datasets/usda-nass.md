...
[Original discovery link](https://www.nass.usda.gov/Data_and_Statistics/index.php). Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

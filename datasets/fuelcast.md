...
[Original discovery link](https://www.fuelcast.net). Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

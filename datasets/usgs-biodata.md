...
| Topics / proposed series | Environmental Monitoring Data; series assignment unconfirmed |
...
[Original discovery link](https://pubs.usgs.gov/fs/2011/3112/). This entry is a discovery lead, not a verified endpoint. Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

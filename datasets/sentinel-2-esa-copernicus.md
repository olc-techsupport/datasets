...
| Topics / proposed series | Satellite and Remote Sensing Data; series assignment unconfirmed |
...
[Original discovery link](https://sentinel.esa.int/web/sentinel/home). This entry is a discovery lead, not a verified endpoint. Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

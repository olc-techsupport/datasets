...
| Topics / series | Geology and Soils Data |
...
Record map publication/revision date, mapping scale and unit ages separately. The reviewed soils repository lists USGS state-geology data; that does not establish which SDGS product was implemented.
...
[Original discovery link](https://www.sdgs.usd.edu/publications/default.aspx). Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

...
| Topics / series | Geographic and Spatial Data; Infrastructure Data; series assignment unconfirmed |
...
Use extract timestamp and feature version/history where relevant; edit timestamps do not establish when a feature was observed on the ground.
...
[Original discovery link](https://www.openstreetmap.org/). Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

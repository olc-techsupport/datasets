...
[Original discovery link](https://data.census.gov/). This entry is a discovery lead, not a verified endpoint. Choose the specific collection or layer and document a bounded download, subset query, or manual request before using it in a series.

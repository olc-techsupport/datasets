...
- Original [catalog](docs/original-catalog.md) and [ingestion](docs/original-ingestion.md) snapshots preserve the earlier inventories.

See [metadata definitions and implementation review](docs/metadata.md) for source coverage, series settings and evidence levels.

## Catalog

`candidate`: discovery lead, specifications/access unverified. `documented`: product and access notes reviewed, download not necessarily tested. `access tested`: the linked bounded example succeeded on its recorded date, not a production readiness guarantee. `retired`: retained for provenance. `implemented`: code exists in a linked repository or implementation is reported by the project owner; this does not imply a live access test. Dataset records distinguish those evidence levels.
...
| --- | --- | --- | --- |
| [USGS Protected Areas Database (PAD-US)](datasets/usgs-protected-areas-database-pad-us.md) | Geographic and Spatial Data | implemented | source candidate |
| [OpenStreetMap (OSM)](datasets/openstreetmap-osm.md) | Geographic and Spatial Data; Infrastructure Data | implemented | source candidate |
| [Boundary Data](datasets/boundary-data.md) | Geographic and Spatial Data | implemented | local / governed resource |
| [POLARIS Soil Dataset](datasets/polaris-soil-dataset.md) | Geology and Soils Data | candidate | source candidate |
| [USDA NRCS Web Soil Survey](datasets/usda-nrcs-web-soil-survey.md) | Geology and Soils Data | implemented | source candidate |
| [SSURGO Downloader (NRCS)](datasets/ssurgo-downloader-nrcs.md) | Geology and Soils Data | documented | source candidate |
| [SoilGrids (ISRIC)](datasets/soilgrids-isric.md) | Geology and Soils Data | documented | source candidate |
| [South Dakota Geological Survey (SDGS)](datasets/south-dakota-geological-survey-sdgs.md) | Geology and Soils Data | implemented | source candidate |
| [USGS National Elevation Dataset (NED)](datasets/usgs-national-elevation-dataset-ned.md) | Elevation and Topography | implemented | source candidate |
| [NASA SRTM (Shuttle Radar Topography Mission)](datasets/nasa-srtm-shuttle-radar-topography-mission.md) | Elevation and Topography | implemented | source candidate |
| [MACAv2-METDATA (THREDDS)](datasets/macav2-metdata-thredds.md) | Climate Data | implemented | source candidate |
...
| [GridMET](datasets/gridmet.md) | Climate Data | implemented | source candidate |
...
| [National Land Cover Database (NLCD)](datasets/national-land-cover-database-nlcd.md) | Vegetation and Land Cover | implemented | source candidate |
...
| [USGS Species Viewer](datasets/usgs-species-viewer.md) | Vegetation and Land Cover | implemented | source candidate |
| [USFS National Grasslands](datasets/usfs-national-grasslands.md) | Vegetation and Land Cover | candidate | portal / resource |
| [NDVI/EVI](datasets/ndvi-evi.md) | Vegetation and Land Cover | implemented | derived product |
| [USGS National Hydrography Dataset (NHDPlus HR)](datasets/usgs-national-hydrography-dataset-nhdplus-hr.md) | Hydrology | implemented | source candidate |
| [NASA GRACE (Groundwater Data)](datasets/nasa-grace-groundwater-data.md) | Hydrology | candidate | source candidate |
| [USGS Water Data for the Nation](datasets/usgs-water.md) | Hydrology | implemented | product / product family |
| [Global Runoff Data Centre (GRDC)](datasets/global-runoff-data-centre-grdc.md) | Hydrology | candidate | source candidate |
| [Landsat (USGS)](datasets/landsat-usgs.md) | Satellite and Remote Sensing Data | implemented | source candidate |
| [Sentinel-2 (ESA Copernicus)](datasets/sentinel-2-esa-copernicus.md) | Satellite and Remote Sensing Data | implemented | source candidate |
...
| [GBIF (Global Biodiversity Information Facility)](datasets/gbif-global-biodiversity-information-facility.md) | Conservation and Wildlife Data | implemented | source candidate |
| [USGS Protected Areas and Species Distributions](datasets/usgs-protected-areas-and-species-distributions.md) | Conservation and Wildlife Data | implemented | source candidate |
...
| [U.S. Census Bureau](datasets/u-s-census-bureau.md) | Socio-Cultural Data | implemented | source candidate |
| [Bureau of Indian Affairs (BIA) GIS](datasets/bureau-of-indian-affairs-bia-gis.md) | Socio-Cultural Data | implemented | source candidate |
